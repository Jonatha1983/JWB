...
public class OvalDrawOperation implements DrawOperation {
    ...
    public OvalDrawOperation(double startXCorner, double startYCorner, double currentW, double currentH, Color stroke, Color fill, Integer thickensLine) {
